...
const CTA = () => {
  ...
  Start improving Diagnostics with AI Today
</h2>
<p>
  Unlock the power of AI-assisted medical imaging to enhance diagnostic accuracy and efficiency. Join leading healthcare providers who are already leveraging our platform to make faster, data-driven decisions for better patient outcomes.
</p>
