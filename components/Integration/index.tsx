...
const Integration = () => {
  ...
  headerInfo={{
    ...
    subtitle: `Detect Lung Disease, Analyze Brain Imaging, and More.`,
    description: `Our platform supports a wide range of diagnostic capabilities, including lung disease detection, brain imaging, and other critical medical analyses powered by AI to assist healthcare professionals in making informed decisions.`,
  }}
/>
            ...
            >
              <div className="inline-block rounded-[10px] bg-white p-4.5 shadow-solid-7 dark:bg-btndark">
                <Image
                  width={50}
                  height={50}
                  src="./images/dicoms/brain_02.svg"
                  alt="Brand"
                />
              </div>
            </motion.div>
            ...
            >
              <div className="inline-block rounded-[10px] bg-white p-4.5 shadow-solid-7 dark:bg-btndark">
                <Image
                  width={50}
                  height={50}
                  src="./images/dicoms/intestine.svg"
                  alt="Brand"
                />
              </div>
            </motion.div>
